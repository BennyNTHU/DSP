function [reconstruct_R, reconstruct_G, reconstruct_B]=IDWTbank(c32, c16, c8, c4, c2, LoR, HiR)
...
% Reconstruct R, G, B Image by inverse_DWT2 function with different gain
reconstruct_RLL4 = inverse_DWT2(c32*R_LL5, c32*R_LH5, c32*R_HL5, c32*R_HH5, LoR, HiR);
reconstruct_RLL3 = inverse_DWT2(c16*reconstruct_RLL4, c16*R_LH4, c16*R_HL4, c16*R_HH4, LoR, HiR);
reconstruct_RLL2 = inverse_DWT2(c8*reconstruct_RLL3, c8*R_LH3, c8*R_HL3, c8*R_HH3, LoR, HiR);
reconstruct_RLL1 = inverse_DWT2(c4*reconstruct_RLL2, c4*R_LH2, c4*R_HL2, c4*R_HH2, LoR, HiR);
reconstruct_R    = inverse_DWT2(c2*reconstruct_RLL1, c2*R_LH1, c2*R_HL1, c2*R_HH1, LoR, HiR);

reconstruct_GLL4 = inverse_DWT2(c32*G_LL5, c32*G_LH5, c32*G_HL5, c32*G_HH5, LoR, HiR);
reconstruct_GLL3 = inverse_DWT2(c16*reconstruct_GLL4, c16*G_LH4, c16*G_HL4, c16*G_HH4, LoR, HiR);
reconstruct_GLL2 = inverse_DWT2(c8*reconstruct_GLL3, c8*G_LH3, c8*G_HL3, c8*G_HH3, LoR, HiR);
reconstruct_GLL1 = inverse_DWT2(c4*reconstruct_GLL2, c4*G_LH2, c4*G_HL2, c4*G_HH2, LoR, HiR);
reconstruct_G    = inverse_DWT2(c2*reconstruct_GLL1, c2*G_LH1, c2*G_HL1, c2*G_HH1, LoR, HiR);

reconstruct_BLL4 = inverse_DWT2(c32*B_LL5, c32*B_LH5, c32*B_HL5, c32*B_HH5, LoR, HiR);
reconstruct_BLL3 = inverse_DWT2(c16*reconstruct_BLL4, c16*B_LH4, c16*B_HL4, c16*B_HH4, LoR, HiR);
reconstruct_BLL2 = inverse_DWT2(c8*reconstruct_BLL3, c8*B_LH3, c8*B_HL3, c8*B_HH3, LoR, HiR);
reconstruct_BLL1 = inverse_DWT2(c4*reconstruct_BLL2, c4*B_LH2, c4*B_HL2, c4*B_HH2, LoR, HiR);
reconstruct_B    = inverse_DWT2(c2*reconstruct_BLL1, c2*B_LH1, c2*B_HL1, c2*B_HH1, LoR, HiR);