function DWTbank(R,G,B,LoD,HiD)

% Implement 5 level 2D DWT on RGB colors
[R_LL1,R_LH1,R_HL1,R_HH1] = waveletanalysis2(R,LoD,HiD);
[R_LL2,R_LH2,R_HL2,R_HH2] = waveletanalysis2(R_LL1,LoD,HiD);
[R_LL3,R_LH3,R_HL3,R_HH3] = waveletanalysis2(R_LL2,LoD,HiD);
[R_LL4,R_LH4,R_HL4,R_HH4] = waveletanalysis2(R_LL3,LoD,HiD);
[R_LL5,R_LH5,R_HL5,R_HH5] = waveletanalysis2(R_LL4,LoD,HiD);

[G_LL1,G_LH1,G_HL1,G_HH1] = waveletanalysis2(G,LoD,HiD);
[G_LL2,G_LH2,G_HL2,G_HH2] = waveletanalysis2(G_LL1,LoD,HiD);
[G_LL3,G_LH3,G_HL3,G_HH3] = waveletanalysis2(G_LL2,LoD,HiD);
[G_LL4,G_LH4,G_HL4,G_HH4] = waveletanalysis2(G_LL3,LoD,HiD);
[G_LL5,G_LH5,G_HL5,G_HH5] = waveletanalysis2(G_LL4,LoD,HiD);

[B_LL1,B_LH1,B_HL1,B_HH1] = waveletanalysis2(B,LoD,HiD);
[B_LL2,B_LH2,B_HL2,B_HH2] = waveletanalysis2(B_LL1,LoD,HiD);
[B_LL3,B_LH3,B_HL3,B_HH3] = waveletanalysis2(B_LL2,LoD,HiD);
[B_LL4,B_LH4,B_HL4,B_HH4] = waveletanalysis2(B_LL3,LoD,HiD);
[B_LL5,B_LH5,B_HL5,B_HH5] = waveletanalysis2(B_LL4,LoD,HiD);
